...
public class MatrixManager {
    ...
    @NonNull
    protected PlayerView.ScaleType currentScaleType = PlayerView.ScaleType.FIT_CENTER;

    @Nullable
    protected Integer requestedRotation = null;
    @Nullable
    protected PlayerView.ScaleType requestedScaleType = null;
    @NonNull
    ...
    @NonNull
    public PlayerView.ScaleType getCurrentScaleType() {
     ...
     */
    public boolean scale(@NonNull View view, @NonNull PlayerView.ScaleType scaleType) {
        if (!ready()) {
    ...
    /**
     * Applies the {@link PlayerView.ScaleType#CENTER} to the specified matrix.  This will
    ...
    /**
     * Applies the {@link PlayerView.ScaleType#CENTER_CROP} to the specified matrix.  This will
    ...
    /**
     * Applies the {@link PlayerView.ScaleType#CENTER_INSIDE} to the specified matrix.  This will
    ...
    /**
     * Applies the {@link PlayerView.ScaleType#FIT_CENTER} to the specified matrix.  This will
